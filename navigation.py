...
def bank_enter(bank_x: int, bank_y: int, bank_name: str, run_time: int, btn_x: int, btn_y: int) -> bool:
    ...
    Args:
        bank_x: координата х банка
        bank_y: координата y банка
        bank_name: название банка
        run_time: время перехода в банка (sec)
        btn_x: координата х кнопки входа (0 или координата)
        btn_y: координата y кнопки входа (0 или координата)
...
def store_enter(store_x: int, store_y: int, store_name: str, run_time: int, btn_x: int, btn_y: int, map_x: int, map_y: int) -> bool:
    ...
    Args:
        store_x: координата х магазина
        store_y: координата y магазина
        store_name: название магазина
        run_time: время перехода в магазин (sec)
        btn_x: координата х кнопки входа (0 или координата)
        btn_y: координата y кнопки входа (0 или координата)
        map_x: координаты x для смещения камеры (0 или координата)
        map_y: координаты y для смещения камеры (0 или координата)
