...
def farm_sub_loc(location_name: str, delay: int, personage: int, event):
    if personage == 1:
        event.wait()
        mouse_click(1370, 540) # 2 рука
        mouse_click(1425, 485) # вызов сигила
        mouse_click(1315, 540) # 1 рука
